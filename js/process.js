...
chtml ="<div style='width: 99%; left: 0.5%; height: 30px; background-color: #242424; margin-top: -8px;     border-radius: 5px 5px 5px 5px; color: #FFFFFF; font-size: 30dp; padding-top: 1%;     padding-left: 1%;'>     <span style='float: left;'>Customer Profile<span></div> <div style='width: 99%; float: left; margin-top: 8px;'>     <div style='width: 86%; float: left; padding-left: 1%;'>         <div style='float: left; width: 100px; height: 30px; font-size: 14px; cursor: default;'             title='Visited more than 5 times in last 3 month'>             <img style='margin-right: 5px; vertical-align: middle;' src='img/Green.png'>Premium</div>         <div style='float: left; width: 100px; height: 30px; font-size: 14px; cursor: default;'             title='Visited more than 2 times in last 3 month'>             <img style='margin-right: 5px; vertical-align: middle;' src='img/Yellow.png'>Regular</div>         <div style='float: left; width: 125px; height: 30px; font-size: 14px; cursor: default;'             title='Visited less than 2 times in last 3 month'>             <img style='margin-right: 5px; vertical-align: middle;' src='img/Red.png'>Less Frequent</div>     </div>     <div style='float: right; width: 10%'>         <div style='border: 0px solid red; width: 35px; height: 10px; margin-top: -7px;'>             <img style='width: 50px; height: 50px;' src="+respData[0].FBProfilePic+"></img></div>     </div>     <div style='float: right; width: 5%'>         <div style='border: 0px solid red; width: 35px; height: 10px; margin-top: -11px;'>             "+FlagToShow+"</div>     </div> </div>  <div style='position:absolute; top:100px; width:98%;height:80%;overflow-y:scroll;'> <div style='width: 100%; height: auto; float: left; margin-top: 3%;'>     <div class='overviewOuterDiv'>         <div class='overviewHeader'>             <img src='img/Personal.png' style='margin-left: -10px; position: absolute;'></img>             <span style='border: 0px solid; margin-left: 20px'><strong>Personal Information</strong></div>         <div class='overviewBlock'>             <div style='width: 100%; height: 100%;'>                 <div class='overviewKey'>                     <span class='overviewKeySpan'>Name:</span></div>                 <div class='overviewVal'>                     <span class='overviewValSpan'>"+respData[0].custname+"</span></div>             </div>             <div style='width: 100%; height: 100%;'>                 <div class='overviewKey'>                     <span class='overviewKeySpan'>Age Group:</span></div>                 <div class='overviewVal'>                     <span class='overviewValSpan'>"+(respData[0].AgeGroup==""?"<i>Not Specified</i>":respData[0].AgeGroup)+"</span></div>             </div>             <div style='width: 100%; height: 100%;'>                 <div class='overviewKey'>                     <span class='overviewKeySpan'>Gender:</span></div>                 <div class='overviewVal'>                     <span id='spnGender' class='overviewValSpan'>"+(respData[0].gender==""?"<i>Not Specified</i>":respData[0].gender)+"</span></div>             </div>             <div style='width: 100%; height: 100%;'>                 <div class='overviewKey'>                     <span class='overviewKeySpan'>DOB:</span></div>                 <div class='overviewVal'>                     <span class='overviewValSpan'>"+(respData[0].dob==""?"<i>Not Specified</i>":respData[0].dob)+"</span></div>             </div>             <div style='width: 100%; height: 100%;'>                 <div class='overviewKey'>                     <span class='overviewKeySpan'>Annv:</span></div>                 <div class='overviewVal'>                     <span class='overviewValSpan'>"+(respData[0].annv==""?"<i>Not Specified</i>":respData[0].annv)+"</span></div>             </div>         </div>     </div>     <div class='overviewOuterDiv'>         <div class='overviewHeader'>             <img src='img/Contact.png' style='margin-left: -10px; position: absolute;'></img>             <span style='border: 0px solid; margin-left: 20px'><strong>Contact Information</strong></div>         <div class='overviewBlock'>             <div style='width: 100%; height: 100%;'>                 <div class='overviewKey'>                     <span class='overviewKeySpan'>Address:</span></div>                 <div class='overviewVal'>                     <span class='overviewValSpan'>"+(respData[0].address==""?"<i>Not Specified</i>":respData[0].address)+"</span></div>             </div>             <div style='width: 100%; height: 100%;'>                 <div class='overviewKey'>                     <span class='overviewKeySpan'>Mobile:</span></div>                 <div class='overviewVal'>                     <span class='overviewValSpan'>"+(respData[0].cmobile==""?"<i>Not Specified</i>":respData[0].cmobile)+"</span></div>             </div>             <div style='width: 100%; height: 100%;'>                 <div class='overviewKey'>                     <span class='overviewKeySpan'>Email:</span></div>                 <div class='overviewVal'>                     <span title='${pagers|Email}' class='overviewValSpan'>"+(respData[0].cemailid==""?"<i>Not                         Specified</i>":respData[0].cemailid)+"</span></div>             </div>             <div style='width: 100%; height: 100%;'>                 <div class='overviewKey'>                     <span class='overviewKeySpan'>Location:</span></div>                 <div class='overviewVal'>                     <span class='overviewValSpan'>"+(respData[0].FBLocation==""?"<i>Not Specified</i>":respData[0].FBLocation)+"</span></div>             </div>             <div style='width: 100%; height: 100%;'>                 <div class='overviewKey'>                     <span class='overviewKeySpan'></span>                 </div>                 <div class='overviewVal'>                     <span class='overviewValSpan'></span>                 </div>             </div>         </div>     </div> </div> <div class='overviewFullOuterDiv' style='height: 190px;'>     <div class='overviewHeader'>         <img src='img/Analytics.png' style='margin-left: -8px; position: absolute;'></img>         <span style='border: 0px solid; margin-left: 20px'><strong>Key Analytics</strong></div>     <div class='overviewFullBlock'>         <div style='width: 100%; height: 100%;'>             <div class='overviewFullKey'>                 <span class='overviewKeySpan'>Last Visit:</span></div>             <div class='overviewFullVal'>                 <span class='overviewValSpan'>"+(respData[0].lastvisiton==""?"<i>Not Specified</i>":"At                     "+respData[0].lastvisitout+" on "+respData[0].lastvisiton)+"</span></div>         </div>         <div style='width: 100%; height: 100%;'>             <div class='overviewFullKey'>                 <span class='overviewKeySpan'>No. Of Visits:</span></div>             <div class='overviewFullVal'>                 <span class='overviewValSpan'>"+(respData[0].noofvisit==""?"0":respData[0].noofvisit)+"</span></div>         </div>         <div style='width: 100%; height: 100%;'>             <div class='overviewFullKey'>                 <span class='overviewKeySpan'>Groups:</span></div>             <div class='overviewFullVal'>                 <span id='groupname' class='overviewValSpan'>"+(respData[0].custgroup==""?"<i>Not Specified</i>":respData[0].custgroup)+"</span></div>         </div>         <div style='width: 100%; height: 100%;'>             <div class='overviewFullKey'>                 <span class='overviewKeySpan'>Last Comment:</span></div>             <div class='overviewFullVal'>                 <span class='overviewValSpan'>"+(respData[0].lastcoment==""?"<i>Not Specified</i>":respData[0].lastcoment)+"</span></div>         </div>         <div style='width: 100%; height: 100%;'>             <div class='overviewFullKey'>                 <span class='overviewKeySpan'>Last Rating:</span></div>             <div class='overviewFullVal'>                 <span class='overviewValSpan'>"+(respData[0].lastrating==""?"<i>Not Specified</i>":respData[0].lastrating)+"</span></div>         </div>     </div> </div> <div class='overviewFullOuterDiv'>     <div class='overviewHeader'>         <img src='img/Preferences.png' style='margin-left: -13px; position: absolute; margin-top: -5px;'>         </img>         <span style='border: 0px solid; margin-left: 20px'><strong>Preferences</strong></span></div>     <div class='overviewFullBlock'>         <div style='width: 100%; height: 100%;'>             <div class='overviewFullKey'>                 <span class='overviewKeySpan'>Food:</span></div>             <div class='overviewFullVal'>                 <span style='float: left; height: 20px'>"+(respData[0].Preference==""?"<i>Not Specified</i>":respData[0].Preference)+"</span></div>         </div>         <div style='width: 100%; height: 100%;'>             <div class='overviewFullKey'>                 <span class='overviewKeySpan'>Dish:</span></div>             <div class='overviewFullVal'>                 <span style='float: left; height: 20px'><i>Not Specified </i></span>             </div>         </div>         <div style='width: 100%; height: 100%;'>             <div class='overviewFullKey'>                 <span class='overviewKeySpan'>Drinks:</span></div>             <div class='overviewFullVal'>                 <span style='float: left; height: 20px'>"+(respData[0].Beverages==""?"<i>Not Specified</i>":respData[0].Beverages)+"</span></div>         </div>     </div> </div> </div> "; 
