...
// **** CopyRight : Mobikon Asia Pte. Ltd.********
...
*/
    ...
    */
    ...
    function jsonpCBDTFn18() {		/* JSON CALL BACK FOR FETCHING BOOKINGS ACCORDING TO TIME */
	 ...
	 function jsonpCBDTFn19() {		/* JSON CALL BACK FOR FETCHING CUSTOMER PROFILE */
...
function ValidateFields() {
   ...
   // alert(parseInt(d1.getMinutes(),10) - parseInt(cmin,10));
    ...
    else if (BookingDate <= day && BookingTime < sessionStorage.BrkFastStart || BookingTime > sessionStorage.BrkFastEnd && BookingTime < sessionStorage.LunchStart || BookingTime > sessionStorage.LunchEnd && BookingTime < sessionStorage.DinnerStart && BookingTime > '00:00:00') {
...
function FetchProfile(ActId,Email,Mobile) {
$('#content').append('<div class="loading"><img src="img/loading.gif" alt="Loading..." /></div>');
	$.ajax({
        type: "POST",
       url: 'http://beta.mobikontech.com/konekt/Service/Query.asmx/GetCustomerProfile',	
	    //  url:'http://localhost/Konektv4/Service/Query.asmx/GetCustomerProfile',
...
function DesignCustomerProfile(respData)
{

var FlagToShow="";
var chtml = "";
if(respData[0].last3mvisit > 5)
  FlagToShow = "<img src='img/green_Flag.png' title='Premium'/>";
else if(respData[0].last3mvisit > 2) 
    FlagToShow = "<img src='img/Yellow_Flag.png' title='Regular'/>";
else
   FlagToShow = "<img src='img/Red_Flag.png' title='Less Frequent'/>";
 
// Changed By Abhilash 
//chtml =	"    <div style='position: absolute; top: 1%; width: 99%; left: 0.5%; height: 4%; background-color: #242424;         border-radius: 5px 5px 5px 5px; color: #FFFFFF; font-size: 30dp; padding-top: 1%;'>         &nbsp;&nbsp;Customer Profile     </div>     <div style='position: absolute; top: 6%; right: 7%; width: 10%;'>         "+FlagToShow+"     </div>     <div style='position: absolute; top: 7%; left: 1%; width: 50%;'>         <img src='img/Green.png' style='padding-left: 2%' title='' />         Premium         <img style='padding-left: 2%' src='img/Yellow.png' title='' />         Regular<img style='padding-left: 2%' src='img/Red.png' title='' />Less Frequent     </div>     <table style='width: 100%; height: 90%; margin-top: 5%; color: #000000;' cellspacing='16'         cellpadding='16'>         <tr>             <td style='width:50%'>                 <img src='img/Personal.png' />                 <span style='color: #9A2F2E'>Personal Information </span>                 <table style='width: 100%; height: 100%; color: #000000; float: left; border: 1px solid #c8c8c8;                     border-radius: 10px 10px 10px 10px;' cellspacing='6' cellpadding='6'>                     <tr>                         <td style='width: 30%; color: #003B99; text-align: right'>                             Name :-                         </td>                         <td style='width: 70%; color: #5F5C6E;'>                             "+respData[0].custname+"                         </td>                     </tr>                     <tr>                         <td style='width: 30%; color: #003B99; text-align: right'>                             Age Group :-                         </td>                         <td style='width: 70%; color: #5F5C6E;'>                             -                         </td>                     </tr>                     <tr>                         <td style='width: 30%; color: #003B99; text-align: right'>                             Gender :-                         </td>                         <td style='width: 70%; color: #5F5C6E;'>                             "+respData[0].gender+"                         </td>                     </tr>                     <tr>                         <td style='width: 30%; color: #003B99; text-align: right'>                             DOB :-                         </td>                         <td style='width: 70%; color: #5F5C6E;'>                             "+respData[0].dob+"                         </td>                     </tr>                     <tr>                         <td style='width: 30%; color: #003B99; text-align: right'>                             Annv :-                         </td>                         <td style='width: 70%; color: #5F5C6E;'>                             "+respData[0].annv+"                         </td>                     </tr>                 </table>             </td>             <td  style='width:50%'>                 <img src='img/Contact.png' />                 <span style='verticle-align: top; color: #9A2F2E'>Contact Information</span>                 <table style='width: 100%; height: 100%; color: #000000; float: right; border: 1px solid #c8c8c8;                     border-radius: 10px 10px 10px 10px;' cellspacing='6' cellpadding='6'>                     <tr>                         <td style='width: 30%; color: #003B99; text-align: right'>                             Address :-                         </td>                         <td style='width: 70%; color: #5F5C6E;'>                             "+(respData[0].address==""?"-":respData[0].address)+"                         </td>                     </tr>                     <tr>                         <td style='width: 30%; color: #003B99; text-align: right'>                             Mobile :-                         </td>                         <td style='width: 70%; color: #5F5C6E;'>                             "+(respData[0].cmobile==""?"-":respData[0].cmobile)+"                         </td>                     </tr>                     <tr>                         <td style='width: 30%; color: #003B99; text-align: right'>                             Email :-                         </td>                         <td style='width: 70%; color: #5F5C6E;'>                             "+(respData[0].cemailid==""?"-":respData[0].cemailid)+"                         </td>                     </tr>                     <tr>                         <td style='width: 30%; color: #003B99; text-align: right'>                             Location :-                         </td>                         <td style='width: 70%; color: #5F5C6E;'>                             -                         </td>                     </tr>                 </table>             </td>         </tr>         <tr>             <td  style='width:50%'>                 <img src='img/Analytics.png' />                 <span style='verticle-align: top; color: #9A2F2E'>Key Analytics</span>                 <table style='width: 100%; height: 100%; color: #000000; float: left; border: 1px solid #c8c8c8;                     border-radius: 10px 10px 10px 10px;' cellspacing='6' cellpadding='6'>                     <tr>                         <td style='width: 30%; color: #003B99; text-align: right'>                             Last Visit :-                         </td>                         <td style='width: 70%; color: #5F5C6E;'>                             At "+respData[0].lastvisitout+" on "+respData[0].lastvisiton+"                         </td>                     </tr>                     <tr>                         <td style='width: 30%; color: #003B99; text-align: right'>                             No of Visits :-                         </td>                         <td style='width: 70%; color: #5F5C6E;'>                             "+respData[0].noofvisit+"                         </td>                     </tr>                     <tr>                         <td style='width: 30%; color: #003B99; text-align: right'>                             Groups :-                         </td>                         <td style='width: 70%; color: #5F5C6E;'>                             -                         </td>                     </tr>                     <tr>                         <td style='width: 30%; color: #003B99; text-align: right'>                             Last Comment :-                         </td>                         <td style='width: 70%; color: #5F5C6E;'>                             "+respData[0].lastcoment+"                         </td>                     </tr>                     <tr>                         <td style='width: 30%; color: #003B99; text-align: right'>                             Last Rating :-                         </td>                         <td style='width: 70%; color: #5F5C6E;'>                             "+respData[0].lastrating+"                         </td>                     </tr>                 </table>             </td>             <td  style='width:50%'>                 <img src='img/Preferences.png' />                 <span style='verticle-align: top; color: #9A2F2E'>Preferences</span>                 <table style='width: 100%; height: 100%; color: #000000; float: right; border: 1px solid #c8c8c8;                     border-radius: 10px 10px 10px 10px;' cellspacing='6' cellpadding='6'>                     <tr>                         <td style='width: 30%; color: #003B99; text-align: right'>                             Food :-                         </td>                         <td style='width: 70%; color: #5F5C6E;'>                             -                         </td>                     </tr>                     <tr>                         <td style='width: 30%; color: #003B99; text-align: right'>                             Dish :-                         </td>                         <td style='width: 70%; color: #5F5C6E;'>                             -                         </td>                     </tr>                     <tr>                         <td style='width: 30%; color: #003B99; text-align: right'>                             Drinks :-                         </td>                         <td style='width: 70%; color: #5F5C6E;'>                             -                         </td>                     </tr>                     <tr>                         <td style='width: 30%; color: #003B99; text-align: right'>                             Location :-                         </td>                         <td style='width: 70%; color: #5F5C6E;'>                             -                         </td>                     </tr>                 </table>             </td>         </tr>     </table>";    
   
chtml =	"    <div style='position: absolute; top: 1%; width: 99%; left: 0.5%; height: 4%; background-color: #242424;         border-radius: 5px 5px 5px 5px; color: #FFFFFF; font-size: 30dp; padding-top: 1%;'>         &nbsp;&nbsp;Customer Profile     </div>     <div style='position: absolute; top: 6%; right: 7%; width: 10%;'>         "+FlagToShow+"     </div>     <div style='position: absolute; top: 7%; left: 1%; width: 50%;'>         <img src='img/Green.png' style='padding-left: 2%' title='' />         Premium         <img style='padding-left: 2%' src='img/Yellow.png' title='' />         Regular<img style='padding-left: 2%' src='img/Red.png' title='' />Less Frequent     </div>     <table style='width: 100%; height: 90%; margin-top: 5%; color: #000000;' cellspacing='16'         cellpadding='16'>         <tr>             <td style='width:50%'>                 <img src='img/Personal.png' />                 <span style='color: #9A2F2E'>Personal Information </span>                 <table style='width: 100%; height: 100%; color: #000000; float: left; border: 1px solid #c8c8c8;                     border-radius: 10px 10px 10px 10px;' cellspacing='6' cellpadding='6'>                     <tr>                         <td style='width: 40%; color: #003B99; text-align: right'>                             Name :-                         </td>                         <td style='width: 60%; color: #5F5C6E;'>                             "+respData[0].custname+"                         </td>                     </tr>                     <tr>                         <td style='width: 40%; color: #003B99; text-align: right'>                             Age Group :-                         </td>                         <td style='width: 60%; color: #5F5C6E;'>                             "+(respData[0].AgeGroup==""?"<i>Not Specified</i>":respData[0].AgeGroup)+"                         </td>                     </tr>                     <tr>                         <td style='width: 40%; color: #003B99; text-align: right'>                             Gender :-                         </td>                         <td style='width: 60%; color: #5F5C6E;'>                              "+(respData[0].gender==""?"<i>Not Specified</i>":respData[0].gender)+"                         </td>                     </tr>                     <tr>                         <td style='width: 40%; color: #003B99; text-align: right'>                             DOB :-                         </td>                         <td style='width: 60%; color: #5F5C6E;'>                             "+(respData[0].dob==""?"<i>Not Specified</i>":respData[0].dob)+"                        </td>                     </tr>                     <tr>                         <td style='width: 40%; color: #003B99; text-align: right'>                             Annv :-                         </td>                         <td style='width: 60%; color: #5F5C6E;'>                             "+(respData[0].annv==""?"<i>Not Specified</i>":respData[0].annv)+"                         </td>                     </tr>                 </table>             </td>             <td  style='width:50%'>                 <img src='img/Contact.png' />                 <span style='verticle-align: top; color: #9A2F2E'>Contact Information</span>                 <table style='width: 100%; height: 100%; color: #000000; float: right; border: 1px solid #c8c8c8;                     border-radius: 10px 10px 10px 10px;' cellspacing='6' cellpadding='6'>                     <tr>                         <td style='width: 40%; color: #003B99; text-align: right'>                             Address :-                         </td>                         <td style='width: 60%; color: #5F5C6E;'>                             "+(respData[0].address==""?"<i>Not Specified</i>":respData[0].address)+"                         </td>                     </tr>                     <tr>                         <td style='width: 40%; color: #003B99; text-align: right'>                             Mobile :-                         </td>                         <td style='width: 60%; color: #5F5C6E;'>                             "+(respData[0].cmobile==""?"<i>Not Specified</i>":respData[0].cmobile)+"                         </td>                     </tr>                     <tr>                         <td style='width: 40%; color: #003B99; text-align: right'>                             Email :-                         </td>                         <td style='width: 60%; color: #5F5C6E;'>                             "+(respData[0].cemailid==""?"<i>Not Specified</i>":respData[0].cemailid)+"                         </td>                     </tr>                     <tr>                         <td style='width: 40%; color: #003B99; text-align: right'>                             Location :-                         </td>                         <td style='width: 60%; color: #5F5C6E;'>                            "+(respData[0].FBLocation==""?"<i>Not Specified</i>":respData[0].FBLocation)+"                         </td>                     </tr>                 </table>             </td>         </tr>         <tr>             <td  style='width:50%'>                 <img src='img/Analytics.png' />                 <span style='verticle-align: top; color: #9A2F2E'>Key Analytics</span>                 <table style='width: 100%; height: 100%; color: #000000; float: left; border: 1px solid #c8c8c8;                     border-radius: 10px 10px 10px 10px;' cellspacing='6' cellpadding='6'>                     <tr>                         <td style='width: 40%; color: #003B99; text-align: right'>                             Last Visit :-                         </td>                         <td style='width: 60%; color: #5F5C6E;'>                             At "+respData[0].lastvisitout+" on "+respData[0].lastvisiton+"                         </td>                     </tr>                     <tr>                         <td style='width: 40%; color: #003B99; text-align: right'>                             No of Visits :-                         </td>                         <td style='width: 60%; color: #5F5C6E;'>                "+(respData[0].noofvisit==""?"0":respData[0].noofvisit)+"                                    </td>                     </tr>                     <tr>                         <td style='width: 40%; color: #003B99; text-align: right'>                             Groups :-                         </td>                         <td style='width: 60%; color: #5F5C6E;'>                             "+respData[0].custgroup+"                         </td>                     </tr>                     <tr>                         <td style='width: 40%; color: #003B99; text-align: right'>                             Last Comment :-                         </td>                         <td style='width: 60%; color: #5F5C6E;'>                              "+(respData[0].lastcoment==""?"<i>Not Specified</i>":respData[0].lastcoment)+"                       </td>                     </tr>                     <tr>                         <td style='width: 40%; color: #003B99; text-align: right'>                             Last Rating :-                         </td>                         <td style='width: 60%; color: #5F5C6E;'>                            "+(respData[0].lastrating==""?"<i>Not Specified</i>":respData[0].lastrating)+"                         </td>                     </tr>                 </table>             </td>             <td  style='width:50%'>                 <img src='img/Preferences.png' />                 <span style='verticle-align: top; color: #9A2F2E'>Preferences</span>                 <table style='width: 100%; height: 100%; color: #000000; float: right; border: 1px solid #c8c8c8;                     border-radius: 10px 10px 10px 10px;' cellspacing='6' cellpadding='6'>                     <tr>                         <td style='width: 40%; color: #003B99; text-align: right'>                             Food :-                         </td>                         <td style='width: 60%; color: #5F5C6E;'>                             "+(respData[0].Preference==""?"<i>Not Specified</i>":respData[0].Preference)+"                           </td>                     </tr>                     <tr>                         <td style='width: 40%; color: #003B99; text-align: right'>                             Dish :-                         </td>                         <td style='width: 60%; color: #5F5C6E;'>                             <i>Not Specified </i>                        </td>                     </tr>                     <tr>                         <td style='width: 40%; color: #003B99; text-align: right'>                             Drinks :-                         </td>                         <td style='width: 60%; color: #5F5C6E;'>                            "+(respData[0].Beverages==""?"<i>Not Specified</i>":respData[0].Beverages)+"                         </td>                     </tr>                                   </table>             </td>         </tr>     </table>"; 
$('#basic-modal-content12').html(chtml);
